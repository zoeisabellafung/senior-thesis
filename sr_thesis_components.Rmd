...
# SLA vs. char height
sla_char_scatter <- ggplot(scatterdata, aes(x=sla_cwm, y=char_ht, color=location)) + 
    geom_point() +
...
sla_scorch_scatter <- ggplot(scatterdata, aes(x=sla_cwm, y=scorch_ht, color=location)) + 
    geom_point() +
...
# SLA vs. crown scorch %
sla_crscpct_scatter <- ggplot(scatterdata, aes(x=sla_cwm, y=cr_sc_pct, color=location)) + 
    geom_point() +
...
ll_char_scatter <- ggplot(scatterdata, aes(x=ll_cwm, y=char_ht, color=location)) + 
    geom_point() +
...
ll_scorch_scatter <- ggplot(scatterdata, aes(x=ll_cwm, y=scorch_ht, color=location)) + 
    geom_point() +
...
ll_crscpct_scatter <- ggplot(scatterdata, aes(x=ll_cwm, y=cr_sc_pct, color=location)) + 
    geom_point() +
...
width_char_scatter <- ggplot(scatterdata, aes(x=width_cwm, y=char_ht, color=location)) + 
    geom_point() +
...
width_scorch_scatter <- ggplot(scatterdata, aes(x=width_cwm, y=scorch_ht, color=location)) + 
    geom_point() +
...
width_crscpct_scatter <- ggplot(scatterdata, aes(x=width_cwm, y=cr_sc_pct, color=location)) + 
    geom_point() +
...
height_char_scatter <- ggplot(scatterdata, aes(x=height_cwm, y=char_ht, color=location)) + 
    geom_point() +
...
height_scorch_scatter <- ggplot(scatterdata, aes(x=height_cwm, y=scorch_ht, color=location)) + 
    geom_point() +
...
height_crscpct_scatter <- ggplot(scatterdata, aes(x=height_cwm, y=cr_sc_pct, color=location)) + 
    geom_point() +
...
curl_char_scatter <- ggplot(scatterdata, aes(x=curl_cwm, y=char_ht, color=location)) + 
    geom_point() +
...
curl_scorch_scatter <- ggplot(scatterdata, aes(x=curl_cwm, y=scorch_ht, color=location)) + 
    geom_point() +
...
# plant height vs. crown scorch %
curl_crscpct_scatter <- ggplot(scatterdata, aes(x=curl_cwm, y=cr_sc_pct, color=location)) + 
    geom_point() +
...
```{r}
# SLA v. char height
lm_sla_char = lm(char_ht~sla_cwm, data = scatterdata) # create the linear regression
summary(lm_sla_char) # review the results --> SIGNIFICANT

# SLA v. scorch height
lm_sla_scorch = lm(scorch_ht~sla_cwm, data = scatterdata) # create the linear regression
summary(lm_sla_scorch) # review the results --> not significant

# SLA v. crown scorch %
lm_sla_crscpct = lm(cr_sc_pct~sla_cwm, data = scatterdata) # create the linear regression
summary(lm_sla_crscpct) # review the results --> SIGNIFICANT

# leaf length v. char height
lm_ll_char = lm(char_ht~ll_cwm, data = scatterdata) # create the linear regression
summary(lm_ll_char) # review the results --> SIGNIFICANT

# leaf length v. scorch height
lm_ll_scorch = lm(scorch_ht~ll_cwm, data = scatterdata) # create the linear regression
summary(lm_ll_scorch) # review the results --> not significant

# leaf length v. crown scorch %
lm_ll_crscpct = lm(cr_sc_pct~ll_cwm, data = scatterdata) # create the linear regression
summary(lm_ll_crscpct) # review the results --> not significant

# leaf width v. char height
lm_width_char = lm(char_ht~width_cwm, data = scatterdata) # create the linear regression
summary(lm_width_char) # review the results --> SIGNIFICANT

# leaf width v. scorch height
lm_width_scorch = lm(scorch_ht~width_cwm, data = scatterdata) # create the linear regression
summary(lm_width_scorch) # review the results --> not significant

# leaf width v. crown scorch %
lm_width_crscpct = lm(cr_sc_pct~width_cwm, data = scatterdata) # create the linear regression
summary(lm_width_crscpct) # review the results --> SIGNIFICANT

# plant veg height v. char height
lm_height_char = lm(char_ht~height_cwm, data = scatterdata) # create the linear regression
summary(lm_height_char) # review the results --> SIGNIFICANT

# plant veg height v. scorch height
lm_height_scorch = lm(scorch_ht~height_cwm, data = scatterdata) # create the linear regression
summary(lm_height_scorch) # review the results --> not significant

# plant veg height v. crown scorch %
lm_height_crscpct = lm(cr_sc_pct~height_cwm, data = scatterdata) # create the linear regression
summary(lm_height_crscpct) # review the results --> SIGNIFICANT

# leaf curl height v. char height
lm_curl_char = lm(char_ht~curl_cwm, data = scatterdata) # create the linear regression
summary(lm_curl_char) # review the results --> SIGNIFICANT

# leaf curl height v. scorch height
lm_curl_scorch = lm(scorch_ht~curl_cwm, data = scatterdata) # create the linear regression
summary(lm_curl_scorch) # review the results --> not significant

# leaf curl height v. crown scorch %
lm_curl_crscpct = lm(cr_sc_pct~curl_cwm, data = scatterdata) # create the linear regression
summary(lm_curl_crscpct) # review the results --> SIGNIFICANT
```
