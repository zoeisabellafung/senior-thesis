...
bm_24_2020_trees <- read.csv("data/Nicole-data/bluffmesadata/BM_24_2020_trees.csv") %>%
  mutate(plot_id = rep(24, length = 8))
bm_25_2020_trees <- read.csv("data/Nicole-data/bluffmesadata/BM_25_2020_trees.csv") %>%
   mutate(plot_id = rep(25, length = 4))
bm_26_2020_trees <- read.csv("data/Nicole-data/bluffmesadata/BM_26_2020_trees.csv") %>%
   mutate(plot_id = rep(26, length = 3))
bm_27_2020_trees <- read.csv("data/Nicole-data/bluffmesadata/BM_27_2020_trees.csv") %>%
   mutate(plot_id = rep(27, length = 3))
bm_33_2020_trees <- read.csv("data/Nicole-data/bluffmesadata/BM_33_2020_trees.csv") %>%
   mutate(plot_id = rep(33, length = 4))
bm_48_2020_trees <- read.csv("data/Nicole-data/bluffmesadata/BM_48_2020_trees.csv") %>%
   mutate(plot_id = rep(48, length = 6))
bm_49_2020_trees <- read.csv("data/Nicole-data/bluffmesadata/BM_49_2020_trees.csv") %>%
   mutate(plot_id = rep(49, length = 10))
bm_50_2020_trees <- read.csv("data/Nicole-data/bluffmesadata/BM_50_2020_trees.csv") %>% 
   mutate(plot_id = rep(50, length = 4))
bm_51_2020_trees <- read.csv("data/Nicole-data/bluffmesadata/BM_51_2020_trees.csv") %>%
   mutate(plot_id = rep(51, length = 4))
bm_52_2020_trees <- read.csv("data/Nicole-data/bluffmesadata/BM_52_2020_trees.csv") %>%
   mutate(plot_id = rep(52, length = 3))
bm_53_2020_trees <- read.csv("data/Nicole-data/bluffmesadata/BM_53_2020_trees.csv") %>%
...
# old calculation for tree area measurement
...
unique(bluffmesa_pre$species) # identify species present in laguna fire data
...
bluffmesa_pre_ABCO_clean <- data.frame(
  ...
  year = rep("2020", times = length(unique(bluffmesa_pre_ABCO$plot_id))),
...
bluffmesa_pre_PIJE_clean <- data.frame(
  ...
  year = rep("2020", times = length(unique(bluffmesa_pre_PIJE$plot_id))),
...
bluffmesa_pre_clean <- rbind(bluffmesa_pre_PIJE_clean, bluffmesa_pre_ABCO_clean)
```
