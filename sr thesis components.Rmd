...
lm_char_plot <- ggplot(laguna_post, aes(plot_id, char_ht)) +
  geom_boxplot(fill = "darkseagreen3")

lm_char_plot

# scorch height across plots at laguna
lm_scorch_plot <- ggplot(laguna_post, aes(plot_id, scorch_ht)) +
  geom_boxplot(fill = "darkseagreen3")

lm_scorch_plot

# crown scorch percent across plots at laguna
lm_crscpct_plot <- ggplot(laguna_post, aes(plot_id, cr_sc_pct)) +
  geom_boxplot(fill = "darkseagreen3")
...
# char height across plots at laguna
bm_char_plot <- ggplot(bluffmesa_post, aes(plot_id, char_ht)) +
  geom_boxplot(fill = "slateblue")

bm_char_plot

# scorch height across plots at laguna
bm_scorch_plot <- ggplot(bluffmesa_post, aes(plot_id, scorch_ht)) +
  geom_boxplot(fill = "slateblue")

bm_scorch_plot

# crown scorch percent across plots at laguna
bm_crscpct_plot <- ggplot(bluffmesa_post, aes(plot_id, cr_sc_pct)) +
  geom_boxplot(fill = "slateblue")
...
# char height across plots at laguna
tf_char_plot <- ggplot(thomas_post, aes(plot_id, char_ht)) +
  geom_boxplot(fill = "plum3")

tf_char_plot

# scorch height across plots at laguna
tf_scorch_plot <- ggplot(thomas_post, aes(plot_id, scorch_ht)) +
  geom_boxplot(fill = "plum3")

tf_scorch_plot

# crown scorch percent across plots at laguna
tf_crscpct_plot <- ggplot(thomas_post, aes(plot_id, cr_sc_pct)) +
  geom_boxplot(fill = "plum3")
