...
# char height
char_mult <- lm(char_ht ~ sla + ll + width + height + curl, data = char_mult_data) # multiple regression model
summary(char_mult) # display results of mult. regression --> not significant
...
# scorch height
scorch_mult <- lm(scorch_ht ~ sla + ll + width + height + curl, data = scorch_mult_data) # multiple regression model
summary(scorch_mult) # display results of mult. regression --> SIGNIFICANT?
...
# crown scorch %
csp_mult <- lm(csp ~ sla + ll + width + height + curl, data = csp_mult_data) # multiple regression model
summary(csp_mult) # display results of mult. regression --> not significant

# mult regression again, without curl and height
char_mult2 <- lm(char_ht ~ sla + ll + width, data = char_mult_data) # multiple regression model
