...
laguna_pre_PIJE_clean <- data.frame(
  project = rep("Laguna Mtn.", times = 25),
...
# to combine data frames w/ same column variables: use rbind()
...
laguna_pre_PIJE_clean <- data.frame(
  ...
  year = rep("2016", length = 25),
  plot_id = c(laguna_pre_PIJE_plots),
  dbh_cm = c(l_p_80, l_p_81, l_p_82, l_p_83, l_p_85, l_p_86, l_p_87, l_p_88, l_p_89, l_p_90, l_p_91, l_p_92, l_p_93, l_p_97, l_p_98, l_p_99, l_p_105, l_p_106, l_p_107, l_p_108, l_p_109, l_p_110, l_p_111, l_p_112, l_p_113)
)
```
